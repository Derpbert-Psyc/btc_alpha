...
|---------|------|---------|
| 1.0 | — | Initial draft |
| 1.1 | — | Added system owner definition, evidence chain, run mode transitions |
| 1.2 | — | Added wrapper prohibition, adapter constraints, CLI output integrity, testing requirements |
| 1.2.1 | — | Added shared infrastructure constraints, core version hash manifest, LIVE input handling |
| 1.2.2 | — | Added HALT completion semantics, configuration immutability, inspect command, failed attempt logging |
| 1.2.3 | — | Tightened pod identity uniqueness, defined inspect redaction and LIVE prohibition, tightened HALT and evidence-chain integrity checks, clarified corruption and compromise conditions |
...
* Timestamp precision must be at least milliseconds.
* The orchestration layer must reject bar submissions with timestamps that would violate monotonicity before calling the core.
