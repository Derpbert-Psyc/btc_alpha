...
.strategy-table.q-table { overflow: visible !important; border-radius: 0 !important; }
.strategy-table .q-table__container { overflow-x: auto; border-radius: 10px; overflow: clip; }
